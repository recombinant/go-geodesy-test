...
func TestOsGridRef(t *testing.T) {
	t.Run("0°",
		func(t *testing.T) {
			...
			osgb2 := gridref.OsGridToLatLon(geodesy.OSGB36)
			assert.Equal(t, osgb2.ToString(geodesy.FmtDMS, 4), "52°39′27.2531″N, 001°43′04.5177″E")
		})
}
...
//
//    osgb = new LatLon(Dms.geodesy.ParseDMS("52°39′27.2531″N"), Dms.geodesy.ParseDMS("1°43′4.5177″E"), LatLon.datum.OSGB36);
